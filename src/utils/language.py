...
class LanguageManager:
    ...
    def load_languages(self):
        ...
        # French
        self.languages['fr'] = {
            'welcome': '🎉 Bienvenue sur Zoo Bot!\n\nChoisissez votre langue / Choose your language / Elige tu idioma:',
            'welcome_menu': '🎉 Bienvenue sur Zoo Bot!\n\n🏰 Construisez votre zoo virtuel\n⭐ Collectez des étoiles de vos animaux\n💰 Gagnez de l\'argent et convertissez en USDT\n🎮 Jouez et gagnez des prix\n👥 Invitez des amis et gagnez des bonus\n\nChoisissez une option du menu:',
            'language_selected': '✅ Langue définie en Français',
            'main_menu': '🏠 Menu Principal',
            'settings': '⚙️ Paramètres',
            'settings_menu': '⚙️ Menu des Paramètres\n\nPersonnalisez vos préférences:',
            'change_language': '🌐 Changer de Langue',
            'withdrawal_address': '📝 Configurer l\'Adresse de Retrait',
            'view_deposits': '💳 Voir les Dépôts',
            'view_withdrawals': '💸 Voir les Retraits',
            'view_stats': '📊 Voir les Statistiques',
            'my_zoo': '🏰 Mon Zoo',
            'collect_stars': '⭐ Collecter les Étoiles',
            'balance': '💰 Solde',
            'games': '🎮 Jeux',
            ...
            'admin': '👑 Admin',
            'back': '🔙 Retour',
            'convert_stars': '⭐➡️💰 Convertir Étoiles en Argent',
            'convert_money': '💰➡️💵 Convertir Argent en USDT',
            'buy_diamonds': '💎 Acheter des Diamants',
            'withdraw': '💸 Retirer',
            'deposit': '💳 Déposer',
            'your_balance': '💰 Votre Solde:\n\n💰 Argent: {money}\n⭐ Étoiles: {stars}\n💎 Diamants: {diamonds}\n💵 USDT: {usdt}',
            'no_animals': '🏰 Votre zoo est vide! Achetez des animaux dans la boutique.',
            'animals_list': '🏰 Animaux de votre Zoo:\n\n{animals}',
            'stars_collected': '⭐ Collecté {stars} étoiles!',
            'no_stars': '⭐ Aucune étoile à collecter pour le moment.',
            'referral_stats': '👥 Statistiques de Parrainage:\n\n🔗 Votre lien de parrainage: {link}\n👥 Total parrainages: {count}\n💰 Gains: {earnings}',
            'shop_menu': '💎 Boutique d\'Animaux\n\nChoisissez une catégorie:',
            'diamond_packages': '💎 Paquets de Diamants\n\nSélectionnez un paquet à acheter:',
            'diamond_purchase_success': '✅ Vous avez acheté {amount} diamants!',
            'common_animals': '🟢 Animaux Communs',
            'rare_animals': '🟡 Animaux Rares',
            'legendary_animals': '🔴 Animaux Légendaires',
            'conversion_rate': 'Taux de conversion: {rate}',
            'insufficient_balance': '❌ Solde insuffisant!',
            'conversion_success': '✅ Converti avec succès!',
        ...
        # German
        self.languages['de'] = {
            'welcome': '🎉 Willkommen bei Zoo Bot!\n\nWählen Sie Ihre Sprache / Choose your language / Elige tu idioma:',
            'welcome_menu': '🎉 Willkommen bei Zoo Bot!\n\n🏰 Bauen Sie Ihren virtuellen Zoo\n⭐ Sammeln Sie Sterne von Ihren Tieren\n💰 Verdienen Sie Geld und konvertieren Sie zu USDT\n🎮 Spielen Sie und gewinnen Sie Preise\n👥 Laden Sie Freunde ein und verdienen Sie Boni\n\nWählen Sie eine Option aus dem Menü:',
            ...
            'admin': '👑 Admin',
            'back': '🔙 Zurück',
            'convert_stars': '⭐➡️💰 Sterne zu Geld Konvertieren',
            'convert_money': '💰➡️💵 Geld zu USDT Konvertieren',
            'buy_diamonds': '💎 Diamanten Kaufen',
            'withdraw': '💸 Auszahlen',
            'deposit': '💳 Einzahlen',
            'your_balance': '💰 Ihr Guthaben:\n\n💰 Geld: {money}\n⭐ Sterne: {stars}\n💎 Diamanten: {diamonds}\n💵 USDT: {usdt}',
            'no_animals': '🏰 Ihr Zoo ist leer! Kaufen Sie Tiere im Shop.',
            'animals_list': '🏰 Ihre Zoo-Tiere:\n\n{animals}',
            'stars_collected': '⭐ {stars} Sterne gesammelt!',
            'no_stars': '⭐ Noch keine Sterne zum Sammeln.',
            'referral_stats': '👥 Empfehlungsstatistiken:\n\n🔗 Ihr Empfehlungslink: {link}\n👥 Gesamt Empfehlungen: {count}\n💰 Verdienst: {earnings}',
            'shop_menu': '💎 Tier-Shop\n\nWählen Sie eine Kategorie:',
            'diamond_packages': '💎 Diamanten-Pakete\n\nWählen Sie ein Paket zum Kauf:',
            'diamond_purchase_success': '✅ Sie haben {amount} Diamanten gekauft!',
            'common_animals': '🟢 Gewöhnliche Tiere',
            'rare_animals': '🟡 Seltene Tiere',
            'legendary_animals': '🔴 Legendäre Tiere',
            'conversion_rate': 'Umrechnungskurs: {rate}',
            'insufficient_balance': '❌ Unzureichendes Guthaben!',
            'conversion_success': '✅ Erfolgreich konvertiert!',
